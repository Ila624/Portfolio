...
| **[Mapping Global Happiness: A Five-Year Data Analysis (2015–2019)](#)** | A comprehensive data analysis project exploring the macroeconomic and socio-cultural drivers of world happiness prior to the COVID-19 pandemic. Built a Python data pipeline to clean and unify five disparate Gallup World Poll datasets, followed by exploratory data analysis (EDA) to uncover regional trend lines, institutional trust impacts, and socio-economic outliers. | Tableau |[📊Slides (Canva) (EN)](https://canva.link/13edofb1grot9u1) <br>  [📊Slides (Canva) (IT)](https://canva.link/a0wu0r31wgjc2xl) <br> [📈 Tableau Dashboard](https://public.tableau.com/shared/MPXHTMT5F?:display_count=n&:origin=viz_share_link)
